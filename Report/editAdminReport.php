    ...
    <main id="main" class="main">
        ...
        if (isset($_POST["submit"])) {
            ...
            if (mysqli_query($db, $updateQuery)) {
                ...
                echo "Error updating report: " . mysqli_error($db);
            }
        }
        ?>
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="RL_ID" value="<?php echo isset($row['R_ID']) ? $row['R_ID'] : ''; ?>" readonly>
                        </div>
                        <div class="col-sm-6">
                            <label for="inputName5" class="form-label">Report Type</label>
                            <input type="text" class="form-control" name="report_type" value="<?php echo isset($row['report_type']) ? $row['report_type'] : ''; ?>">
                        </div>
                        <div class="col-12">
                            <label for="inputName4" class="form-label">Report Description</label>
                            <input type="text" class="form-control" name="report_description" value="<?php echo isset($row['report_description']) ? $row['report_description'] : ''; ?>">
                        </div>
                        <div class="col-12">
                            <label for="inputName4" class="form-label">Report Solution</label>
                            <input type="text" class="form-control" name="report_solution" value="<?php echo isset($row['report_solution']) ? $row['report_solution'] : ''; ?>">
                        </div>
                        <div class="col-sm-6">
                            ...
                            <select class="form-select" name="report_status" aria-label="Default select example">
                                <option value="In Investigation" <?php echo isset($row['report_status']) && $row['report_status'] == 'In Investigation' ? 'selected' : ''; ?>>In Investigation</option>
                                <option value="Resolved" <?php echo isset($row['report_status']) && $row['report_status'] == 'Resolved' ? 'selected' : ''; ?>>Resolved</option>
                                <option value="On Hold" <?php echo isset($row['report_status']) && $row['report_status'] == 'On Hold' ? 'selected' : ''; ?>>On Hold</option>
                            </select>
                        </div>

...
<body>
    ...
    <div class="centercontent">
        ...
        <div id="column main-content">
            <a href="../User/DiscussionBoard.php">&laquo; Home</a><a>&nbsp; &nbsp;</a>
            <button onclick="window.location.href='../User/SearchAndCategories.php';">
                Category / Search Post
            </button>
            <button onclick="window.location.href='../User/ManageRatingAndFeedback.php';">
                Rating & Feedback <i class='far fa-star' style='font-size:24px'></i>
            </button>
            <button onclick="window.location.href='../User/CreateNewPost.php';">
                Create New Post <i class='far fa-edit' style='font-size:24px'></i>
            </button>

            <div class="tab">
                <button class="tablinks" onclick="openPost(event, 'allQuestions')">All Questions</button>
                <button class="tablinks" onclick="openPost(event, 'yourPost')">Your Post</button>
            </div>
                    ...
                    <?php if (mysqli_num_rows($result2)) { ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $rows['post_category'] ?></td>
                                <td><?php echo $rows['post_date'] ?><br><?php echo $rows['post_time'] ?></td>
                                <td><?php echo $rows['postStatus'] ?></td>
                                <td><a href="php/calLike.php"><i class='far fa-thumbs-up' style='font-size:24px;color:darkblue'></i></a></td>
                            </tr>
                        <?php } ?>
                </table>
            <?php } ?>

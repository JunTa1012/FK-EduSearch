    ...
    <div class="column LeftNavigationbar">
         ...
         <nav id="nav-bar">
            <ul>
                ...
                <li><a class="nav-link active" href="../User/UserDiscussionBoard.php">Discussion Board</a></li>
        ...
        <div id="column main-content">
           ...
           <form action="" method="POST">
            ...
            <label>Question: </label> <input type="text"  id="post_content" name="question"><br>
            <label>Expert's Answer:</label> <input type="text"  id="expert_answer" name="expertAns"><br>
            <label>Expert's Name: </label> <input type="text"  id="expert_name" name="expertName"><br>
            <label>Feedback: </label><textarea rows="5" cols="300" name="post_feedback" id="post_feedback">Give Your Feedback</textarea>
            <br><br>

            ...
            <div class="table-wrapper">
                <div class="content">
                    <div style="margin-bottom: 12px;">
                        ...
                        <button type="button" class="btn btn-default" style="float: right;" onclick="window.location.href='complaintreportpage.php'">Generate Report</button> 
                        <button type="button" class="btn btn-default" style="float: right;" onclick="window.location.href='complaintmainpage.php'">Go Back</button> 
                    </div>
                    <!-- CRUD table -->
                    <table id="complaintTableAll">
                        ...
                        <tbody>
                            <?php
                                $sql = "SELECT SUM(Total_Complaints) AS Total FROM (SELECT COUNT(*) AS Total_Complaints FROM complaint_list GROUP BY Complaint_ID) AS subquery";
                                $result = $conn->query($sql);
                                $row = mysqli_fetch_assoc($result);
                                $totalComplaints = $row['Total'];
                                $sql = "SELECT Complaint_date, Complaint_type, COUNT(*) AS Total_Complaints FROM complaint_list GROUP BY Complaint_ID ORDER BY Complaint_date ASC";
                                $result = $conn->query($sql);
                    ...
                    <table id="complaintTableDay">
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT DAYNAME(Complaint_date) AS hari, Complaint_type, COUNT(*) AS Total_Complaints FROM complaint_list GROUP BY DAYNAME(Complaint_date), Complaint_type ORDER BY Complaint_date DESC";
                                $result = $conn->query($sql);
                    ...
                    <table id="complaintTableWeek">
                        ...
                        <tbody>
                            <?php
                                // Get the total number of complaints
                                $sql = "SELECT WEEK(Complaint_date) AS minggu, Complaint_type, COUNT(*) AS Total_Complaints FROM complaint_list GROUP BY WEEK(Complaint_date), Complaint_type";
                                $result = $conn->query($sql);
                                // Assuming you have the appropriate SQL query to fetch the data from the database
                                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <table id="complaintTableMonth">
                        ...
                        <tbody>
                            <?php
                                // Get the total number of complaints
                                $sql = "SELECT MONTHNAME(Complaint_date) AS month, Complaint_type, COUNT(*) AS Total_Complaints FROM complaint_list GROUP BY MONTHNAME(Complaint_date), Complaint_type ORDER BY Complaint_date ASC";
                                $result = $conn->query($sql);
                                // Assuming you have the appropriate SQL query to fetch the data from the database
                                while ($row = mysqli_fetch_assoc($result)) {

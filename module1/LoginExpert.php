...
if(isset($_POST["submit"])){
  ...
  $result = mysqli_query($conn, "SELECT * FROM expert WHERE expert_name = '$username'");
    ...
    <div class="login-page">
        <div class="form">
          <form action="" method="POST" id="login-form" class="login-form">
            ...
            <input type="text" name="expert_name" placeholder="Username" required/>
            <input type="password" name="expert_password" placeholder="Password" required/>
